      ...
      <div class="container-fluid"   >
        ...
        <div class=" collapse navbar-collapse" id="navbarNavDropdown">
          <ul class="navbar-nav ms-auto ">
            ...
            <li class="nav-item">
              <a class="nav-link mx-2" style="color:#F1EFEF;" href="#">Orders</a>
            </li>
              ...
              <table class="table mb-0">
                ...
                <tbody>
                  ...
                  while($orderInfo =  mysqli_fetch_array($result)){
                    echo "<tr>";
                    echo "<td>".$orderInfo["id"]."</td>";
                    echo "<td>".$orderInfo["userId"]."</td>";

                    echo "<td>".$orderInfo["numOfPruducts"]."</td>";
                    echo "<td>".$orderInfo["numOfitems"]."</td>";
                    echo "<td>".$orderInfo["totalPrice"]."</td>";
                    echo "<td>".$orderInfo["orderDate"]."</td>";
                    echo "<td>".$orderInfo["orderState"]."</td>";

                    echo "<td><a href='accept.php?id=$orderInfo[id]'> <i class='fa-solid fa-pen-to-square'></i></a> </td>";
                    echo "</tr>";
