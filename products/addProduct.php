            ...
            if($quantity !=0 ){
                if($price != 0){
                    if (in_array(strtolower($lastElementExt), $arrFile) ){
                          ...
                          $sql= "insert into products (name, cat, quantity, img, price) VALUES ('$name','$cat', $quantity,'$fileNewName',$price)";
          ...
          <div class="card-body p-md-5">
            <div class="row justify-content-center">
              <div class="col-md-10 col-lg-6 col-xl-5 order-2 order-lg-1">
                ...
                <p class="text-center h1 fw-bold mb-5 mx-1 mx-md-4 mt-4" style="color:#2E4374;">Add Product</p>
                ...
                <form class="mx-1 mx-md-4" action="" method="POST" enctype="multipart/form-data" >
                  ...
                  <div class="d-flex flex-row align-items-center mb-4">
                    ...
                    <div class="form-outline flex-fill mb-0">
                      <input type="number" id="form3Example3c" value="0"
